...
public class AnotaIntervalos extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mTableLayoutView = new TableLayoutView(this, tableLayout, R.layout.linha_anotacao);
	...
	private void listarAnotacoes()
	{
		...
		int[] destino = new int[] {
			R.id.listaAnotacoes_posicao,
			R.id.listaAnotacoes_dataHora,
			R.id.listaAnotacoes_linha,
			R.id.listaAnotacoes_estacao,
			R.id.listaAnotacoes_sentido
		};
		
		SimpleCursorAdapter adapterAnotacoes = new SimpleCursorAdapter(this, R.layout.linha_anotacao, listaAnotacoes, origem, destino);
		adapterAnotacoes.setViewBinder(new AnotacoesViewBinder());
		
		mTableLayoutView.setAdapter(adapterAnotacoes);
		
		//setListAdapter(adapterAnotacoes);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		if((requestCode == ANOTACAO_ADICIONAR || requestCode == ANOTACAO_EDITAR) && resultCode == RESULT_OK)
		{
			listarAnotacoes();
		}
	}
